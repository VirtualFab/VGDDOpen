...
AppCopyright=Copyright © VirtualFab 2011-2012
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=VirtualFab
AppPublisher=VirtualFab
...
[Files]
Source: "src\VGDD.exe"; DestDir: "{app}";
...
[Icons]
Name: "{group}\VGDD"; Filename: "{app}\VGDD"
Name: "{group}\{cm:UninstallProgram,VGDD}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\VGDD"; Filename: "{app}\VGDD.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\VGDD"; Filename: "{app}\VGDD.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\VGDD.exe"; Description: "{cm:LaunchProgram,VGDD}"; Flags: nowait postinstall skipifsilent
