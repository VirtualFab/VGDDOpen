...
#define ADDR15        LATDbits.LATD10        //PCAP
#define ADDR15_TRIS   TRISDbits.TRISD10      //PCAP
...
#else
//#define PIXEL_DRAW_PER_DMA_TX          20 // Standard from MLA
#define PIXEL_DRAW_PER_DMA_TX          50
#endif
...
//#define  PMADDR_OVERFLOW               32768 // Standard from MLA
#define  PMADDR_OVERFLOW               65536          /* Set for 2^15 because that is how many address lines are connected from the PIC32*/
