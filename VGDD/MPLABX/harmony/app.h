...
// *****************************************************************************
/* Application flash events

  Summary:
    Application flash enumeration

  Description:
    This enumeration defines the valid flash events.  These states
    determine the behavior of the application during flash operations.
*/

typedef enum
{
    /* Calibration state machine's initial state. */
    APP_FLASH_CALIBRATION_VERSION_EVENT=0,

    APP_FLASH_IDLE,

    APP_FLASH_TOUCHPOINT_EVENT,
