...
// Using HX8347D Display Controller
    ...
    #define DISP_VER_RESOLUTION 320
        ...
        //Additional Macros needed for the MCHP_DA210
...
*/
#if defined (GFX_PICTAIL_LCC) || defined (MEB_2_BOARD)
//No PMP Setup Here
#else
...
#if defined (GFX_PICTAIL_V3) || defined (GFX_PICTAIL_V3E) || defined(GFX_PICTAIL_LCC) || defined(MEB_2_BOARD)
