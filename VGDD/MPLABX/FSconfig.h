 ...
 * (the (c)Company(c)) for its PICmicro(c) Microcontroller is intended and
 * supplied to you, the Company(c)s customer, for use solely and
...
// Description: Function pointer to the Write Protect Check Physical Layer function
    ...
    #elif defined(USE_SSD1926_SDCARD)  // SD card reader on SSD1926
