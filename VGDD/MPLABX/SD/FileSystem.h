/*********************************************************************
 *
 *     MODIFIED File system access interface layer header File
 *
 *********************************************************************
...
#include "HardwareProfile.h"
    ...
    #define FILESYSTEM_USE_FATFS
    #if defined(STACK_USE_MPFS2)
    #undef STACK_USE_MPFS2
    #endif
#elif defined(STACK_USE_MPFS2)
    #define FILESYSTEM_USE_MPFS2
#elif defined(STACK_USE_MDD)
    #define FILESYSTEM_USE_MDD
#endif
 
#if defined FILESYSTEM_USE_MPFS2
