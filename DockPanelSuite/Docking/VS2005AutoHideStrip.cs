...
namespace WeifenLuo.WinFormsUI.Docking
{
    internal class VS2005AutoHideStrip : AutoHideStripBase
    {
        ...
        private void DrawTab(Graphics g, TabVS2005 tab)
        {
            ...
            if (tab.Content.DockHandler.ActiveGradient != null) {
                startColor = tab.Content.DockHandler.ActiveGradient.StartColor;
                endColor = tab.Content.DockHandler.ActiveGradient.EndColor;
                textColor = tab.Content.DockHandler.ActiveGradient.TextColor;
            } else {
                startColor = DockPanel.Skin.AutoHideStripSkin.TabGradient.StartColor;
                endColor = DockPanel.Skin.AutoHideStripSkin.TabGradient.EndColor;
                textColor = DockPanel.Skin.AutoHideStripSkin.TabGradient.TextColor;
            }
