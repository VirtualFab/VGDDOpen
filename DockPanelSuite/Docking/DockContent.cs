...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class DockContent : Form, IDockContent
	{
        ...
        [LocalizedDescription("DockContent_ActiveGradient_Description")]
        [DefaultValue(null)]
        public TabGradient ActiveGradient
        {
            get { return DockHandler.ActiveGradient; }
            set { DockHandler.ActiveGradient = value; }
        }

        [LocalizedCategory("Category_Docking")]
        [LocalizedDescription("DockContent_InactiveGradient_Description")]
        [DefaultValue(null)]
        public TabGradient InactiveGradient
        {
            get { return DockHandler.InactiveGradient; }
            set { DockHandler.InactiveGradient = value; }
        }
