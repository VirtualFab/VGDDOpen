...
namespace WeifenLuo.WinFormsUI.Docking
{
	internal class VS2005DockPaneCaption : DockPaneCaptionBase
	{
		...
		private void DrawCaption(Graphics g)
		{
            ...
            if (DockPane.IsActivated)
            {
                if (DockPane.ActiveContent.DockHandler.ActiveGradient != null) {
                    startColor = DockPane.ActiveContent.DockHandler.ActiveGradient.StartColor;
                    endColor = DockPane.ActiveContent.DockHandler.ActiveGradient.EndColor;
                    textColor = DockPane.ActiveContent.DockHandler.ActiveGradient.TextColor;
                    gradientMode = DockPane.ActiveContent.DockHandler.ActiveGradient.LinearGradientMode;
                } else {
                    startColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.StartColor;
                    endColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.EndColor;
                    textColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.TextColor;
                    gradientMode = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.LinearGradientMode;
                }
            ...
            {
                if (DockPane.ActiveContent !=null && DockPane.ActiveContent.DockHandler.ActiveGradient != null) {
                    startColor = DockPane.ActiveContent.DockHandler.ActiveGradient.StartColor;
                    endColor = DockPane.ActiveContent.DockHandler.ActiveGradient.EndColor;
                    textColor = DockPane.ActiveContent.DockHandler.ActiveGradient.TextColor;
                    gradientMode = DockPane.ActiveContent.DockHandler.ActiveGradient.LinearGradientMode;
                } else {
                    startColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.StartColor;
                    endColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.EndColor;
                    textColor = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.TextColor;
                    gradientMode = DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.LinearGradientMode;
                }
                //using (LinearGradientBrush brush = new LinearGradientBrush(ClientRectangle, startColor, endColor, gradientMode)) {
                //    brush.Blend = ActiveBackColorGradientBlend;
                //    g.FillRectangle(brush, ClientRectangle);
